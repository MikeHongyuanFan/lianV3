...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedProductList();
  });
  ...
  describe('PaginatedProductList', function() {
    it('should create an instance of PaginatedProductList', function() {
      // uncomment below and update the code to test PaginatedProductList
      //var instance = new CrmClientJs.PaginatedProductList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedProductList);
    });
