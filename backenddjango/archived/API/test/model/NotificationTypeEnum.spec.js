...
(function(root, factory) {
  ...
  describe('NotificationTypeEnum', function() {
    it('should create an instance of NotificationTypeEnum', function() {
      // uncomment below and update the code to test NotificationTypeEnum
      //var instance = new CrmClientJs.NotificationTypeEnum();
      //expect(instance).to.be.a(CrmClientJs.NotificationTypeEnum);
    });
