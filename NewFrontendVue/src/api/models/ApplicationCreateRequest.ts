...
import type { BorrowerRequest } from './BorrowerRequest';
import type { CompanyBorrowerRequest } from './CompanyBorrowerRequest';
import type { FundingCalculationInputRequest } from './FundingCalculationInputRequest';
import type { GuarantorRequest } from './GuarantorRequest';
...
export type ApplicationCreateRequest = {
    ...
    stage?: StageEnum;
    borrowers?: Array<BorrowerRequest>;
    guarantors?: Array<GuarantorRequest>;
    company_borrowers?: Array<CompanyBorrowerRequest>;
    ...
    funding_calculation_input?: FundingCalculationInputRequest;
};
