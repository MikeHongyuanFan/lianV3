...
/**
 * The BorrowerDetailRequest model module.
 * @module models/BorrowerDetailRequest
 * @version 1.0.0
 */
class BorrowerDetailRequest {
    /**
     * Constructs a new <code>BorrowerDetailRequest</code>.
     * Serializer for detailed borrower information
     * @alias module:models/BorrowerDetailRequest
     */
    constructor() { 
        
        BorrowerDetailRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BorrowerDetailRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/BorrowerDetailRequest} obj Optional instance to populate.
     * @return {module:models/BorrowerDetailRequest} The populated <code>BorrowerDetailRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BorrowerDetailRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BorrowerDetailRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BorrowerDetailRequest</code>.
     */
 ...
 */
BorrowerDetailRequest.prototype['first_name'] = undefined;

/**
 * @member {String} last_name
 */
BorrowerDetailRequest.prototype['last_name'] = undefined;

/**
 * @member {Date} date_of_birth
 */
BorrowerDetailRequest.prototype['date_of_birth'] = undefined;

/**
 * @member {String} email
 */
BorrowerDetailRequest.prototype['email'] = undefined;

/**
 * @member {String} phone
 */
BorrowerDetailRequest.prototype['phone'] = undefined;

/**
 * @member {String} residential_address
 */
BorrowerDetailRequest.prototype['residential_address'] = undefined;

/**
 * @member {String} mailing_address
 */
BorrowerDetailRequest.prototype['mailing_address'] = undefined;

/**
 * Tax File Number or equivalent
 * @member {String} tax_id
 */
BorrowerDetailRequest.prototype['tax_id'] = undefined;

/**
 * @member {module:models/BorrowerMaritalStatus} marital_status
 */
BorrowerDetailRequest.prototype['marital_status'] = undefined;

/**
 * @member {module:models/BorrowerResidencyStatus} residency_status
 */
BorrowerDetailRequest.prototype['residency_status'] = undefined;

/**
 * @member {module:models/BorrowerDetailEmploymentType} employment_type
 */
BorrowerDetailRequest.prototype['employment_type'] = undefined;

/**
 * @member {String} employer_name
 */
BorrowerDetailRequest.prototype['employer_name'] = undefined;

/**
 * @member {String} employer_address
 */
BorrowerDetailRequest.prototype['employer_address'] = undefined;

/**
 * @member {String} job_title
 */
BorrowerDetailRequest.prototype['job_title'] = undefined;

/**
 * Duration in months
 * @member {Number} employment_duration
 */
BorrowerDetailRequest.prototype['employment_duration'] = undefined;

/**
 * @member {Number} annual_income
 */
BorrowerDetailRequest.prototype['annual_income'] = undefined;

/**
 * @member {Number} other_income
 */
BorrowerDetailRequest.prototype['other_income'] = undefined;

/**
 * @member {Number} monthly_expenses
 */
BorrowerDetailRequest.prototype['monthly_expenses'] = undefined;

/**
 * @member {String} bank_name
 */
BorrowerDetailRequest.prototype['bank_name'] = undefined;

/**
 * @member {String} bank_account_name
 */
BorrowerDetailRequest.prototype['bank_account_name'] = undefined;

/**
 * @member {String} bank_account_number
 */
BorrowerDetailRequest.prototype['bank_account_number'] = undefined;

/**
 * @member {String} bank_bsb
 */
BorrowerDetailRequest.prototype['bank_bsb'] = undefined;

/**
 * @member {String} referral_source
 */
BorrowerDetailRequest.prototype['referral_source'] = undefined;

/**
 * @member {String} tags
 */
BorrowerDetailRequest.prototype['tags'] = undefined;

/**
 * @member {String} notes_text
 */
BorrowerDetailRequest.prototype['notes_text'] = undefined;

/**
 * @member {Boolean} is_company
 */
BorrowerDetailRequest.prototype['is_company'] = undefined;

/**
 * @member {String} company_name
 */
BorrowerDetailRequest.prototype['company_name'] = undefined;

/**
 * @member {String} company_abn
 */
BorrowerDetailRequest.prototype['company_abn'] = undefined;

/**
 * @member {String} company_acn
 */
BorrowerDetailRequest.prototype['company_acn'] = undefined;

/**
 * @member {String} company_address
 */
BorrowerDetailRequest.prototype['company_address'] = undefined;

/**
 * @member {Number} user
 */
BorrowerDetailRequest.prototype['user'] = undefined;
...
export default BorrowerDetailRequest;
