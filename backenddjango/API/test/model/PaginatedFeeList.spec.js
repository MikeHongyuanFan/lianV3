...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedFeeList();
  });
  ...
  describe('PaginatedFeeList', function() {
    it('should create an instance of PaginatedFeeList', function() {
      // uncomment below and update the code to test PaginatedFeeList
      //var instance = new CrmClientJs.PaginatedFeeList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedFeeList);
    });
