...
(function(root, factory) {
  ...
  describe('RoleEnum', function() {
    it('should create an instance of RoleEnum', function() {
      // uncomment below and update the code to test RoleEnum
      //var instance = new CrmClientJs.RoleEnum();
      //expect(instance).to.be.a(CrmClientJs.RoleEnum);
    });
