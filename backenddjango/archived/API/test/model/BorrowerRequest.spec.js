...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.BorrowerRequest();
  });
  ...
  describe('BorrowerRequest', function() {
    it('should create an instance of BorrowerRequest', function() {
      // uncomment below and update the code to test BorrowerRequest
      //var instance = new CrmClientJs.BorrowerRequest();
      //expect(instance).to.be.a(CrmClientJs.BorrowerRequest);
    });
