...
/**
 * The PatchedApplicationDetailRequest model module.
 * @module models/PatchedApplicationDetailRequest
 * @version 1.0.0
 */
class PatchedApplicationDetailRequest {
    /**
     * Constructs a new <code>PatchedApplicationDetailRequest</code>.
     * @alias module:models/PatchedApplicationDetailRequest
     */
    constructor() { 
        
        PatchedApplicationDetailRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchedApplicationDetailRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/PatchedApplicationDetailRequest} obj Optional instance to populate.
     * @return {module:models/PatchedApplicationDetailRequest} The populated <code>PatchedApplicationDetailRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchedApplicationDetailRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchedApplicationDetailRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchedApplicationDetailRequest</code>.
     */
 ...
 */
PatchedApplicationDetailRequest.prototype['reference_number'] = undefined;

/**
 * @member {Number} loan_amount
 */
PatchedApplicationDetailRequest.prototype['loan_amount'] = undefined;

/**
 * Loan term in months
 * @member {Number} loan_term
 */
PatchedApplicationDetailRequest.prototype['loan_term'] = undefined;

/**
 * @member {Number} interest_rate
 */
PatchedApplicationDetailRequest.prototype['interest_rate'] = undefined;

/**
 * @member {String} purpose
 */
PatchedApplicationDetailRequest.prototype['purpose'] = undefined;

/**
 * @member {module:models/RepaymentFrequencyEnum} repayment_frequency
 */
PatchedApplicationDetailRequest.prototype['repayment_frequency'] = undefined;

/**
 * @member {module:models/ApplicationCreateApplicationType} application_type
 */
PatchedApplicationDetailRequest.prototype['application_type'] = undefined;

/**
 * @member {String} product_id
 */
PatchedApplicationDetailRequest.prototype['product_id'] = undefined;

/**
 * @member {Date} estimated_settlement_date
 */
PatchedApplicationDetailRequest.prototype['estimated_settlement_date'] = undefined;

/**
 * @member {module:models/StageEnum} stage
 */
PatchedApplicationDetailRequest.prototype['stage'] = undefined;

/**
 * @member {String} security_address
 */
PatchedApplicationDetailRequest.prototype['security_address'] = undefined;

/**
 * @member {String} security_type
 */
PatchedApplicationDetailRequest.prototype['security_type'] = undefined;

/**
 * @member {Number} security_value
 */
PatchedApplicationDetailRequest.prototype['security_value'] = undefined;

/**
 * @member {String} valuer_company_name
 */
PatchedApplicationDetailRequest.prototype['valuer_company_name'] = undefined;

/**
 * @member {String} valuer_contact_name
 */
PatchedApplicationDetailRequest.prototype['valuer_contact_name'] = undefined;

/**
 * @member {String} valuer_phone
 */
PatchedApplicationDetailRequest.prototype['valuer_phone'] = undefined;

/**
 * @member {String} valuer_email
 */
PatchedApplicationDetailRequest.prototype['valuer_email'] = undefined;

/**
 * @member {Date} valuation_date
 */
PatchedApplicationDetailRequest.prototype['valuation_date'] = undefined;

/**
 * @member {Number} valuation_amount
 */
PatchedApplicationDetailRequest.prototype['valuation_amount'] = undefined;

/**
 * @member {String} qs_company_name
 */
PatchedApplicationDetailRequest.prototype['qs_company_name'] = undefined;

/**
 * @member {String} qs_contact_name
 */
PatchedApplicationDetailRequest.prototype['qs_contact_name'] = undefined;

/**
 * @member {String} qs_phone
 */
PatchedApplicationDetailRequest.prototype['qs_phone'] = undefined;

/**
 * @member {String} qs_email
 */
PatchedApplicationDetailRequest.prototype['qs_email'] = undefined;

/**
 * @member {Date} qs_report_date
 */
PatchedApplicationDetailRequest.prototype['qs_report_date'] = undefined;

/**
 * @member {String} signed_by
 */
PatchedApplicationDetailRequest.prototype['signed_by'] = undefined;

/**
 * @member {Date} signature_date
 */
PatchedApplicationDetailRequest.prototype['signature_date'] = undefined;

/**
 * @member {File} uploaded_pdf_path
 */
PatchedApplicationDetailRequest.prototype['uploaded_pdf_path'] = undefined;

/**
 * Stores the current funding calculation result
 * @member {Object} funding_result
 */
PatchedApplicationDetailRequest.prototype['funding_result'] = undefined;
...
export default PatchedApplicationDetailRequest;
