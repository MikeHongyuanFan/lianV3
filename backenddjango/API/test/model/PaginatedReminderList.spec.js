...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedReminderList();
  });
  ...
  describe('PaginatedReminderList', function() {
    it('should create an instance of PaginatedReminderList', function() {
      // uncomment below and update the code to test PaginatedReminderList
      //var instance = new CrmClientJs.PaginatedReminderList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedReminderList);
    });
