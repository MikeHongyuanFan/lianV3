<template>
  <div class="borrower-applications-list">
    <!-- Loading state -->
    ...
    <div v-else-if="!applications.length" class="text-center py-8 bg-gray-50 rounded-lg">
      <p class="text-gray-500 mb-4">No applications found for this borrower</p>
      <button
...
export default {
  ...
  setup(props) {
    ...
    const fetchApplications = async () => {
      ...
      try {
        const response = await borrowerService.getBorrowerApplications(props.borrowerId)
