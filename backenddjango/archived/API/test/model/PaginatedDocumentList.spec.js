...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedDocumentList();
  });
  ...
  describe('PaginatedDocumentList', function() {
    it('should create an instance of PaginatedDocumentList', function() {
      // uncomment below and update the code to test PaginatedDocumentList
      //var instance = new CrmClientJs.PaginatedDocumentList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedDocumentList);
    });
