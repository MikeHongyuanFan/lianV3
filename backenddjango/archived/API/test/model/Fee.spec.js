...
(function(root, factory) {
  ...
  describe('Fee', function() {
    it('should create an instance of Fee', function() {
      ...
      //var instance = new CrmClientJs.Fee();
      //expect(instance).to.be.a(CrmClientJs.Fee);
    });
    ...
    it('should have the property feeTypeDisplay (base name: "fee_type_display")', function() {
      // uncomment below and update the code to test the property feeTypeDisplay
      //var instance = new CrmClientJs.Fee();
      //expect(instance).to.be();
    });
