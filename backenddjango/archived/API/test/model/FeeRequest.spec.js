...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.FeeRequest();
  });
  ...
  describe('FeeRequest', function() {
    it('should create an instance of FeeRequest', function() {
      // uncomment below and update the code to test FeeRequest
      //var instance = new CrmClientJs.FeeRequest();
      //expect(instance).to.be.a(CrmClientJs.FeeRequest);
    });
