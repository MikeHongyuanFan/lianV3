...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedBDMList();
  });
  ...
  describe('PaginatedBDMList', function() {
    it('should create an instance of PaginatedBDMList', function() {
      // uncomment below and update the code to test PaginatedBDMList
      //var instance = new CrmClientJs.PaginatedBDMList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedBDMList);
    });
