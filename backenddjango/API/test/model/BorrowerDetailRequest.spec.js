...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.BorrowerDetailRequest();
  });
  ...
  describe('BorrowerDetailRequest', function() {
    it('should create an instance of BorrowerDetailRequest', function() {
      // uncomment below and update the code to test BorrowerDetailRequest
      //var instance = new CrmClientJs.BorrowerDetailRequest();
      //expect(instance).to.be.a(CrmClientJs.BorrowerDetailRequest);
    });
