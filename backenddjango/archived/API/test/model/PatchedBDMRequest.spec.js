...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PatchedBDMRequest();
  });
  ...
  describe('PatchedBDMRequest', function() {
    it('should create an instance of PatchedBDMRequest', function() {
      // uncomment below and update the code to test PatchedBDMRequest
      //var instance = new CrmClientJs.PatchedBDMRequest();
      //expect(instance).to.be.a(CrmClientJs.PatchedBDMRequest);
    });
