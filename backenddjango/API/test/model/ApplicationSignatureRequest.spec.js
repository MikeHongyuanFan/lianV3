...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.ApplicationSignatureRequest();
  });
  ...
  describe('ApplicationSignatureRequest', function() {
    it('should create an instance of ApplicationSignatureRequest', function() {
      // uncomment below and update the code to test ApplicationSignatureRequest
      //var instance = new CrmClientJs.ApplicationSignatureRequest();
      //expect(instance).to.be.a(CrmClientJs.ApplicationSignatureRequest);
    });
