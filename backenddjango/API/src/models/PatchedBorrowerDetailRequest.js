...
/**
 * The PatchedBorrowerDetailRequest model module.
 * @module models/PatchedBorrowerDetailRequest
 * @version 1.0.0
 */
class PatchedBorrowerDetailRequest {
    /**
     * Constructs a new <code>PatchedBorrowerDetailRequest</code>.
     * Serializer for detailed borrower information
     * @alias module:models/PatchedBorrowerDetailRequest
     */
    constructor() { 
        
        PatchedBorrowerDetailRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PatchedBorrowerDetailRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/PatchedBorrowerDetailRequest} obj Optional instance to populate.
     * @return {module:models/PatchedBorrowerDetailRequest} The populated <code>PatchedBorrowerDetailRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PatchedBorrowerDetailRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PatchedBorrowerDetailRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PatchedBorrowerDetailRequest</code>.
     */
 ...
 */
PatchedBorrowerDetailRequest.prototype['first_name'] = undefined;

/**
 * @member {String} last_name
 */
PatchedBorrowerDetailRequest.prototype['last_name'] = undefined;

/**
 * @member {Date} date_of_birth
 */
PatchedBorrowerDetailRequest.prototype['date_of_birth'] = undefined;

/**
 * @member {String} email
 */
PatchedBorrowerDetailRequest.prototype['email'] = undefined;

/**
 * @member {String} phone
 */
PatchedBorrowerDetailRequest.prototype['phone'] = undefined;

/**
 * @member {String} residential_address
 */
PatchedBorrowerDetailRequest.prototype['residential_address'] = undefined;

/**
 * @member {String} mailing_address
 */
PatchedBorrowerDetailRequest.prototype['mailing_address'] = undefined;

/**
 * Tax File Number or equivalent
 * @member {String} tax_id
 */
PatchedBorrowerDetailRequest.prototype['tax_id'] = undefined;

/**
 * @member {module:models/BorrowerMaritalStatus} marital_status
 */
PatchedBorrowerDetailRequest.prototype['marital_status'] = undefined;

/**
 * @member {module:models/BorrowerResidencyStatus} residency_status
 */
PatchedBorrowerDetailRequest.prototype['residency_status'] = undefined;

/**
 * @member {module:models/BorrowerDetailEmploymentType} employment_type
 */
PatchedBorrowerDetailRequest.prototype['employment_type'] = undefined;

/**
 * @member {String} employer_name
 */
PatchedBorrowerDetailRequest.prototype['employer_name'] = undefined;

/**
 * @member {String} employer_address
 */
PatchedBorrowerDetailRequest.prototype['employer_address'] = undefined;

/**
 * @member {String} job_title
 */
PatchedBorrowerDetailRequest.prototype['job_title'] = undefined;

/**
 * Duration in months
 * @member {Number} employment_duration
 */
PatchedBorrowerDetailRequest.prototype['employment_duration'] = undefined;

/**
 * @member {Number} annual_income
 */
PatchedBorrowerDetailRequest.prototype['annual_income'] = undefined;

/**
 * @member {Number} other_income
 */
PatchedBorrowerDetailRequest.prototype['other_income'] = undefined;

/**
 * @member {Number} monthly_expenses
 */
PatchedBorrowerDetailRequest.prototype['monthly_expenses'] = undefined;

/**
 * @member {String} bank_name
 */
PatchedBorrowerDetailRequest.prototype['bank_name'] = undefined;

/**
 * @member {String} bank_account_name
 */
PatchedBorrowerDetailRequest.prototype['bank_account_name'] = undefined;

/**
 * @member {String} bank_account_number
 */
PatchedBorrowerDetailRequest.prototype['bank_account_number'] = undefined;

/**
 * @member {String} bank_bsb
 */
PatchedBorrowerDetailRequest.prototype['bank_bsb'] = undefined;

/**
 * @member {String} referral_source
 */
PatchedBorrowerDetailRequest.prototype['referral_source'] = undefined;

/**
 * @member {String} tags
 */
PatchedBorrowerDetailRequest.prototype['tags'] = undefined;

/**
 * @member {String} notes_text
 */
PatchedBorrowerDetailRequest.prototype['notes_text'] = undefined;

/**
 * @member {Boolean} is_company
 */
PatchedBorrowerDetailRequest.prototype['is_company'] = undefined;

/**
 * @member {String} company_name
 */
PatchedBorrowerDetailRequest.prototype['company_name'] = undefined;

/**
 * @member {String} company_abn
 */
PatchedBorrowerDetailRequest.prototype['company_abn'] = undefined;

/**
 * @member {String} company_acn
 */
PatchedBorrowerDetailRequest.prototype['company_acn'] = undefined;

/**
 * @member {String} company_address
 */
PatchedBorrowerDetailRequest.prototype['company_address'] = undefined;

/**
 * @member {Number} user
 */
PatchedBorrowerDetailRequest.prototype['user'] = undefined;
...
export default PatchedBorrowerDetailRequest;
