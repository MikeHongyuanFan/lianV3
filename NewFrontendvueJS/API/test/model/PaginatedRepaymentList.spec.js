...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedRepaymentList();
  });
  ...
  describe('PaginatedRepaymentList', function() {
    it('should create an instance of PaginatedRepaymentList', function() {
      // uncomment below and update the code to test PaginatedRepaymentList
      //var instance = new CrmClientJs.PaginatedRepaymentList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedRepaymentList);
    });
