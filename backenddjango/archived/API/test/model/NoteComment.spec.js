...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.NoteComment();
  });
  ...
  describe('NoteComment', function() {
    it('should create an instance of NoteComment', function() {
      // uncomment below and update the code to test NoteComment
      //var instance = new CrmClientJs.NoteComment();
      //expect(instance).to.be.a(CrmClientJs.NoteComment);
    });
