...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedNoteList();
  });
  ...
  describe('PaginatedNoteList', function() {
    it('should create an instance of PaginatedNoteList', function() {
      // uncomment below and update the code to test PaginatedNoteList
      //var instance = new CrmClientJs.PaginatedNoteList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedNoteList);
    });
