...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PatchedBorrowerDetailRequest();
  });
  ...
  describe('PatchedBorrowerDetailRequest', function() {
    it('should create an instance of PatchedBorrowerDetailRequest', function() {
      // uncomment below and update the code to test PatchedBorrowerDetailRequest
      //var instance = new CrmClientJs.PatchedBorrowerDetailRequest();
      //expect(instance).to.be.a(CrmClientJs.PatchedBorrowerDetailRequest);
    });
