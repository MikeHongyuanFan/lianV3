 ...
 * @module models/PaginatedUserList
 * @version 1.0.0
 */
class PaginatedUserList {
    /**
     * Constructs a new <code>PaginatedUserList</code>.
     * @alias module:models/PaginatedUserList
     */
    constructor() { 
     ...
     * @param {module:models/PaginatedUserList} obj Optional instance to populate.
     * @return {module:models/PaginatedUserList} The populated <code>PaginatedUserList</code> instance.
     */
...
/**
 * @member {Array.<module:models/User>} results
 */
