 ...
 * @module models/TokenRefresh
 * @version 1.0.0
 */
class TokenRefresh {
    /**
     * Constructs a new <code>TokenRefresh</code>.
     * @alias module:models/TokenRefresh
     * @param access {String} 
     */
    constructor(access) { 
        
        TokenRefresh.initialize(this, access);
    }
     ...
     * @param {module:models/TokenRefresh} obj Optional instance to populate.
     * @return {module:models/TokenRefresh} The populated <code>TokenRefresh</code> instance.
     */
...
TokenRefresh.RequiredProperties = ["access"];
