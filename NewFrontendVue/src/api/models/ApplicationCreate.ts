...
import type { CompanyBorrower } from './CompanyBorrower';
import type { FundingCalculationInput } from './FundingCalculationInput';
...
export type ApplicationCreate = {
    ...
    readonly bd_id: number | null;
    borrowers?: Array<Borrower>;
    guarantors?: Array<Guarantor>;
    company_borrowers?: Array<CompanyBorrower>;
    ...
    funding_calculation_input?: FundingCalculationInput;
};
