...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PatchedProductRequest();
  });
  ...
  describe('PatchedProductRequest', function() {
    it('should create an instance of PatchedProductRequest', function() {
      // uncomment below and update the code to test PatchedProductRequest
      //var instance = new CrmClientJs.PatchedProductRequest();
      //expect(instance).to.be.a(CrmClientJs.PatchedProductRequest);
    });
