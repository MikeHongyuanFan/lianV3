...
class UserRequest {
     ...
     * @alias module:models/UserRequest
     * @param email {String} 
     */
    constructor(email) { 
        
        UserRequest.initialize(this, email);
    }
     ...
     * @param {module:models/UserRequest} obj Optional instance to populate.
     * @return {module:models/UserRequest} The populated <code>UserRequest</code> instance.
     */
...
UserRequest.RequiredProperties = ["email"];
 ...
 * @member {String} phone
 */
UserRequest.prototype['phone'] = undefined;
