...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.BDMRequest();
  });
  ...
  describe('BDMRequest', function() {
    it('should create an instance of BDMRequest', function() {
      // uncomment below and update the code to test BDMRequest
      //var instance = new CrmClientJs.BDMRequest();
      //expect(instance).to.be.a(CrmClientJs.BDMRequest);
    });
