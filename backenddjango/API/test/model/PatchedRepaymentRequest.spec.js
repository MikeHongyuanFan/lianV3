...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PatchedRepaymentRequest();
  });
  ...
  describe('PatchedRepaymentRequest', function() {
    it('should create an instance of PatchedRepaymentRequest', function() {
      // uncomment below and update the code to test PatchedRepaymentRequest
      //var instance = new CrmClientJs.PatchedRepaymentRequest();
      //expect(instance).to.be.a(CrmClientJs.PatchedRepaymentRequest);
    });
