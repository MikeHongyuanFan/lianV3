...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.FundingCalculationInputRequest();
  });
  ...
  describe('FundingCalculationInputRequest', function() {
    it('should create an instance of FundingCalculationInputRequest', function() {
      // uncomment below and update the code to test FundingCalculationInputRequest
      //var instance = new CrmClientJs.FundingCalculationInputRequest();
      //expect(instance).to.be.a(CrmClientJs.FundingCalculationInputRequest);
    });
