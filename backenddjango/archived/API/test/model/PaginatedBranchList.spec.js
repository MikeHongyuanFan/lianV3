...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.PaginatedBranchList();
  });
  ...
  describe('PaginatedBranchList', function() {
    it('should create an instance of PaginatedBranchList', function() {
      // uncomment below and update the code to test PaginatedBranchList
      //var instance = new CrmClientJs.PaginatedBranchList();
      //expect(instance).to.be.a(CrmClientJs.PaginatedBranchList);
    });
