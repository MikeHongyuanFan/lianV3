...
(function(root, factory) {
  ...
  describe('TransactionTypeEnum', function() {
    it('should create an instance of TransactionTypeEnum', function() {
      // uncomment below and update the code to test TransactionTypeEnum
      //var instance = new CrmClientJs.TransactionTypeEnum();
      //expect(instance).to.be.a(CrmClientJs.TransactionTypeEnum);
    });
