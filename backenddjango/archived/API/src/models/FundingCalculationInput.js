...
/**
 * The FundingCalculationInput model module.
 * @module models/FundingCalculationInput
 * @version 1.0.0
 */
class FundingCalculationInput {
    /**
     * Constructs a new <code>FundingCalculationInput</code>.
     * Serializer for funding calculation input fields
     * @alias module:models/FundingCalculationInput
    ...
    constructor(establishmentFeeRate, monthlyLineFeeRate, brokerageFeeRate, applicationFee, dueDiligenceFee, legalFeeBeforeGst, valuationFee, monthlyAccountFee) { 
        ...
        FundingCalculationInput.initialize(this, establishmentFeeRate, monthlyLineFeeRate, brokerageFeeRate, applicationFee, dueDiligenceFee, legalFeeBeforeGst, valuationFee, monthlyAccountFee);
    }
    ...
    /**
     * Constructs a <code>FundingCalculationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/FundingCalculationInput} obj Optional instance to populate.
     * @return {module:models/FundingCalculationInput} The populated <code>FundingCalculationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FundingCalculationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>FundingCalculationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FundingCalculationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FundingCalculationInput.RequiredProperties) {
...
FundingCalculationInput.RequiredProperties = ["establishment_fee_rate", "monthly_line_fee_rate", "brokerage_fee_rate", "application_fee", "due_diligence_fee", "legal_fee_before_gst", "valuation_fee", "monthly_account_fee"];

/**
 * @member {Number} establishment_fee_rate
 */
FundingCalculationInput.prototype['establishment_fee_rate'] = undefined;

/**
 * @member {Number} capped_interest_months
 * @default 9
 */
FundingCalculationInput.prototype['capped_interest_months'] = 9;

/**
 * @member {Number} monthly_line_fee_rate
 */
FundingCalculationInput.prototype['monthly_line_fee_rate'] = undefined;

/**
 * @member {Number} brokerage_fee_rate
 */
FundingCalculationInput.prototype['brokerage_fee_rate'] = undefined;

/**
 * @member {Number} application_fee
 */
FundingCalculationInput.prototype['application_fee'] = undefined;

/**
 * @member {Number} due_diligence_fee
 */
FundingCalculationInput.prototype['due_diligence_fee'] = undefined;

/**
 * @member {Number} legal_fee_before_gst
 */
FundingCalculationInput.prototype['legal_fee_before_gst'] = undefined;

/**
 * @member {Number} valuation_fee
 */
FundingCalculationInput.prototype['valuation_fee'] = undefined;

/**
 * @member {Number} monthly_account_fee
 */
FundingCalculationInput.prototype['monthly_account_fee'] = undefined;

/**
 * @member {Number} working_fee
 * @default '0.00'
 */
FundingCalculationInput.prototype['working_fee'] = '0.00';
...
export default FundingCalculationInput;
