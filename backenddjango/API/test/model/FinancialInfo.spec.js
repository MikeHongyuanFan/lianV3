...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.FinancialInfo();
  });
  ...
  describe('FinancialInfo', function() {
    it('should create an instance of FinancialInfo', function() {
      // uncomment below and update the code to test FinancialInfo
      //var instance = new CrmClientJs.FinancialInfo();
      //expect(instance).to.be.a(CrmClientJs.FinancialInfo);
    });
