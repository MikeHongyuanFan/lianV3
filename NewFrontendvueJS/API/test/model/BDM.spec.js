...
(function(root, factory) {
  ...
  describe('BDM', function() {
    it('should create an instance of BDM', function() {
      // uncomment below and update the code to test BDM
      //var instance = new CrmClientJs.BDM();
      //expect(instance).to.be.a(CrmClientJs.BDM);
    });
