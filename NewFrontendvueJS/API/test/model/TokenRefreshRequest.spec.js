...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmClientJs.TokenRefreshRequest();
  });
  ...
  describe('TokenRefreshRequest', function() {
    it('should create an instance of TokenRefreshRequest', function() {
      // uncomment below and update the code to test TokenRefreshRequest
      //var instance = new CrmClientJs.TokenRefreshRequest();
      //expect(instance).to.be.a(CrmClientJs.TokenRefreshRequest);
    });
